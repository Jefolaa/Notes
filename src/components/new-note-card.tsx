...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
   ...
   function handleStopRecording() {
    ...
    return (
        <Dialog.Root>
            <Dialog.Trigger className='rounded-md flex-col bg-slate-700 p-5 space-y-3 text-left outline-none hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400'>
